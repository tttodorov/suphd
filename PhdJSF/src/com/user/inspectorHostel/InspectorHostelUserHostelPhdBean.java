package com.user.inspectorHostel;
...
@SessionScoped
@ManagedBean(name = "inspectorHostelUserHostelPhd", eager = true)
public class InspectorHostelUserHostelPhdBean implements Serializable {
