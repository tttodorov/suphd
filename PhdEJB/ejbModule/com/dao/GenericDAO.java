...
public class GenericDAO<T> {
	...
	public List<T> getAll() {
		CriteriaQuery cq = emMes.getCriteriaBuilder().createQuery();
		cq.select(cq.from(entityClass));
		return emMes.createQuery(cq).getResultList();
	}
	...
	protected T findOneResult(String namedQuery, Map<String, Object> parameters) {
		...
		try {
			...
			@SuppressWarnings("unused")
			Log log = new Log("ERROR GenericDAO: Error while running query: " + e.getMessage());
		}
		return result;
	}
